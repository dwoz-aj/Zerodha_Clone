    ...
    return (
        <div className="container">
            <div className='row p-5 mt-5 mb-5'>
                <h1 className="text-center fs-2">We pioneered the discount broking model in India.<br/>
...
</p><p>Today, our disruptive pricing models and in-house technology have made us the biggest stock broker in India.

</p><p>Over 1+ Crore clients place millions of orders every day through our powerful ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.</p>
                </div>
                <div className='col-6 p-5'>
